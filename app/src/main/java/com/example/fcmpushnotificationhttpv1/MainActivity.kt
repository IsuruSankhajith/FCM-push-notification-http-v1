...
import com.example.fcmpushnotificationhttpv1.ui.theme.FCMpushnotificationhttpv1Theme

class MainActivity : ComponentActivity() {

    // Corrected initialization of ViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            FCMpushnotificationhttpv1Theme {
                Surface (
                    ...
                    if (state.isEnteringToken) {
                        ...
                        ChatScreen(
                            ...
                            onMessageChanging = viewModel::onMessageChange
                        )
                    }
                }
            }
